This guile is used to install VMware, RHEL 9.5, Kubernetes v1.31 on local MacBook Pro  

```
env, tools, guilde used:
MacBook Pro 2019, 2.3 GHz 8-Core Intel Core i9, Sonoma 14.6.1, 32GB RAM

VMware Fusion 12.2.5 (20904517), user registration is required for learning.
If needd, click menu VMware Fusion, check for update, update and install 

Download RHEL 9.5 DVD iso, user registration is required for learning.
...
x_86_64, DVD iso, Release date Nov 12, 2024, Download (10.99 GB)

Kubernetes on RHEL installation guide
https://infotechys.com/install-a-kubernetes-cluster-on-rhel-9/

Official kubernetes documentation
https://kubernetes.io/docs/setup/production-environment/tools/kubeadm/create-cluster-kubeadm/

Visual Studio Code (for remote connection to run terminal commands) 
https://code.visualstudio.com/docs/setup/mac

kubectl completion (for easy run commands)
...
VMWare Fusion, new, drag rhel-9.5-x86_64-dvd.iso onto popup window
...
# configure installation disk on Settings window
...
Note: press Control+Command to display cursor on screen
# On virtual machine window, click Play button to start installation
Select
...
/Users/<your_mac_user>/.ssh/config  # select this option to save ssh config
...
#### Initializing Kubernetes Control Plane (on control plane node)
